    ...
    <div class="carttable">
      <div class="container">
        ...
        <h5 class="text-end mb-3">
          <a href="products.html" class="text-muted">Continue Shopping</a>
        </h5> 
        <div class="row">
          <div class="col-md-12 col-sm-12 text-center">
            <table
              class="table table-sm align-middle table-bordered  border-dark"
              id="cartTable"
            >
        ...
        <button type="button" class="btn btn-secondary">Total : 5,880</button>
